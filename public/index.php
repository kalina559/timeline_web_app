...
<html>
  <body>
    ...
    <div class="body-background">
      ...
      <header>
        <nav id="nav-left-menu" class="fill">
          <ul>
            <li data-bind="css: { active: appModel.currentPage() === 'timeline' }">
              <a href="#" data-bind="click: function () {appModel.changePage('timeline');}, css: { disable: appModel.busy }">Timeline</a>
            </li>

            <li data-bind="css: { active: appModel.currentPage() === 'about' }">
              <a href="#" data-bind="click: function () {appModel.changePage('about');}, css: { disable: appModel.busy }">About the website</a>
            </li>
          </ul>
        </nav>
      ...
      <!-- Page: Timeline -->
      <div id="timeline-page" data-bind="visible: currentPage() == 'timeline'">
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <div class="form-group modal-field">
                    ...
                    <div class="col-sm-8">
                      <input required id="start-date" data-bind="value: eventStartDate" type="date" class="form-control">
                    </div>
                  </div>
                  <div class="form-group modal-field">
                    <label for="end-date" class="col-sm-offset-1 col-sm-4 control-label">End date (optional):</label>
                    <div class="col-sm-8">
                      <input id="end-date" data-bind="value: eventEndDate" type="date" class="form-control">
                    </div>
                  </div>
                  <div class="form-group modal-field">
                  ...
                  <div class="form-group modal-field">
                    ...
                    <div class="col-sm-8">
                      ...
                      <button type="button" class="btn btn-default" data-bind="click: clearImageFile">Clear image</button>
                    </div>
                  </div>
                </div>
                <div class="modal-footer">
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="form-group modal-field">
                  ...
                  <div class="col-sm-8">
                    <input type="password" required id="current-password" data-bind="value: currentPassword" class="form-control">
                  </div>
                </div>
                <div class="form-group modal-field">
